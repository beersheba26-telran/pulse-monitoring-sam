...
def _resolve_db_credentials() -> tuple[str, str, str]:
    ...
    uri = secret_obj["MONGO_URI"]
    db_name = secret_obj["MONGO_DB_NAME"]
    collection_name = secret_obj["JUMPS_VALUES_COLLECTION"]
...
def _build_document(data: dict) -> dict:
    ...
    current_pulse_value = data["current_pulse_value"]
    previous_pulse_value = data["previous_pulse_value"]
